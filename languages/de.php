...
$german = array(
  ...
  'event_calendar:no_such_event_edit_error' => "Fehler: Es gibt diese Veranstaltung nicht, oder Sie haben nicht die Berechtigung, um sie zu bearbeiten.",
  ...
  'event_calendar:manage_event_description' => "Geben Sie die Details Ihrer Veranstaltung an. "
    ...
    ."Sie können auf die Kalendersymbole klicken, um die Start-und Enddatum festlegen.",
  ...
  'event_calendar:end_date_description' => "Wann wird diese Veranstaltung enden? Das Startdatum wird"
    ."wird verwendet wenn kein Enddatum angegeben wird.",
  ...
  'event_calendar:long_description_description' => "Kann ein Absatz oder wenn erforderlich mehr umfassen."/* todo:,
